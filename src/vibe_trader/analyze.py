...
when the user (or `vibe-trader analyze` CLI) explicitly asks "what's
...
from vibe_trader.models import Indicator, Position, Quote, Symbol
    ...
    *,
    ...
    if sym is None:
        return AnalysisResult(
            ...
            error=f"symbol not in DB (run `vibe-trader watchlist sync` first)",
        )
